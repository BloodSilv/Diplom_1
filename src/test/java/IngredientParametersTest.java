...
public class IngredientParametersTest {
    ...
    */
        ...
        assertEquals("Тип ингридиентов не совпадает", type, expectedType);
        assertEquals("Название ингидиента не совпадает", name, expectedName);
        assertEquals("Цена не совпадает", price, expectedPrice, 0);
