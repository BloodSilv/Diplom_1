...
public class BurgerMockStubTest {
    ...
    public void addIngredient() {
        ...
        assertEquals("Количество ингидиентов не совпадает",burger.ingredients.size(), 2);
    }
    ...
    public void removeIngredient() {
        ...
        assertEquals("Количество ингидиентов не совпадает",burger.ingredients.size(), 1);
    }
    ...
    public void getPrice() {
        ...
        assertEquals("Цены не совпадают", 1100, burger.getPrice(),0);
        // Check second price [1000*2 + 100 + 150]
        burger.addIngredient(ingredient);
        assertEquals("Цены не совпадают",2250, burger.getPrice(),0);
    }
    ...
    public void getReceipt() {
        ...
        String expectedResult = "" +
                ...
                "\r\n" +
                "Price: 1100,000000\r\n" ;
        assertEquals("Рецепты не совпадают",expectedResult, receipt);
    }
}
